...
const teamMembers = [
  {
    ...
    description: "Spécialisé dans le développement backend, Arno assure la robustesse et la performance de notre infrastructure.",
    image: "AS" // Initiales en attendant la photo
  },
  {
    name: "Clément Vier",
    role: "Développeur Fullstack",
    description: "En tant que développeur fullstack, Clément apporte sa polyvalence et son expertise sur l'ensemble de notre stack technique.",
    image: "CV"
  },
  {
  ...
  },
  {
    ...
    description: "Responsable de l'expérience utilisateur, Liam crée des interfaces intuitives et esthétiques.",
    image: "/Liam.jpg"
  },
  {
    name: "Lucas Bretenstein",
    role: "Développeur Backend",
    description: "Lucas assure la solidité de notre backend et optimise les performances de nos services.",
    image: "LB"
  },
  {
    name: "Martin Stocq",
    role: "Développeur Frontend",
    description: "Martin travaille sur l'interface utilisateur pour offrir la meilleure expérience possible.",
    image: "MS"
  }
];
    ...
    <div className="min-h-screen p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto px-4">
        {teamMembers.map((member, index) => (
          <div key={index} className="h-[300px] w-[300px] mx-auto perspective-[1000px] cursor-pointer group">
