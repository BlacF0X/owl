  ...
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:gap-8">
      ...
      <Link href="/dashboard/windows">
        <div
          className={`flex flex-col group relative overflow-hidden rounded-[2rem] bg-white p-8 shadow-xl border transition-all duration-500 hover:scale-[1.02] cursor-pointer ${
            openWindowsCount > 0
        ...
        >
          <div
            className={`absolute top-0 right-0 h-full w-2 bg-gradient-to-b ${
          ...
          <div className="relative z-10 flex flex-col h-full">
            <div className="flex items-center justify-between">
              <div
                className={`rounded-2xl p-3 ${openWindowsCount > 0 ? 'bg-red-50 text-red-600' : 'bg-emerald-50 text-emerald-600'}`}
              >
                {openWindowsCount > 0 ? (
      ...
      <Link href="/dashboard/temperatures-datas">
        <div
          className={`flex flex-col group relative overflow-hidden rounded-[2rem] bg-white p-8 shadow-xl border transition-all duration-500 hover:scale-[1.02] cursor-pointer ${tempStyles.border} ${tempStyles.shadow}`}
        >
          <div
            className={`absolute top-0 right-0 h-full w-2 bg-gradient-to-b ${tempStyles.gradient}`}
          />
          ...
          <div className="relative z-10 flex flex-col h-full">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <span
                  className={`text-xs font-bold uppercase px-2 py-1 rounded-md ${tempStyles.bgBadge} ${tempStyles.textBadge}`}
                >
                  {tempLabel}
                </span>
              </div>
      ...
      <Link href="/dashboard/humidity-sensors">
        <div
          className={`flex flex-col group relative overflow-hidden rounded-[2rem] bg-white p-8 shadow-xl border transition-all duration-500 hover:scale-[1.02] cursor-pointer ${humStyles.border} ${humStyles.shadow}`}
        >
          <div
            className={`absolute top-0 right-0 h-full w-2 bg-gradient-to-b ${humStyles.gradient}`}
          />
          ...
          <div className="relative z-10 flex flex-col h-full">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <span
                  className={`text-xs font-bold uppercase px-2 py-1 rounded-md ${humStyles.bgBadge} ${humStyles.textBadge}`}
                >
                  {humidityLabel}
                </span>
              </div>
      ...
      <Link href="/dashboard/co2-sensors">
        <div
          className={`flex flex-col group relative overflow-hidden rounded-[2rem] bg-white p-8 shadow-xl border transition-all duration-500 hover:scale-[1.02] cursor-pointer ${co2Styles.border} ${co2Styles.shadow}`}
        >
          <div
            className={`absolute top-0 right-0 h-full w-2 bg-gradient-to-b ${co2Styles.gradient}`}
          />
          ...
          <div className="relative z-10 flex flex-col h-full">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <span
                  className={`text-xs font-bold uppercase px-2 py-1 rounded-md ${co2Styles.bgBadge} ${co2Styles.textBadge}`}
                >
                  {co2Label}
                </span>
              </div>
