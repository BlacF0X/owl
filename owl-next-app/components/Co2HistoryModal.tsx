                  ...
                  <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
                    ...
                    <div className="flex justify-between mt-3 text-xs font-medium text-slate-500">
                      <div className="flex items-center gap-1.5">
                        <span className="w-2 h-2 rounded-full bg-emerald-500"></span> Excellente (
                        {Math.round(goodPercent)}%)
                      </div>
                      <div className="flex items-center gap-1.5">
                        <span className="w-2 h-2 rounded-full bg-amber-500"></span> Moyenne (
                        {Math.round(mediumPercent)}%)
                      </div>
                      <div className="flex items-center gap-1.5">
                        <span className="w-2 h-2 rounded-full bg-rose-500"></span> Critique (
