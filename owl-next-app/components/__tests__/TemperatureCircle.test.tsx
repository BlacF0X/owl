...
describe('TemperatureCircle Component', () => {
  ...
  it('affiche correctement le nom du capteur et la température', () => {
    render(
      <TemperatureCircle sensorName="Salon" temperature={22.5} />
    );
  ...
  it('applique la couleur bleue pour une température froide', () => {
    const { container } = render(
      <TemperatureCircle sensorName="Cave" temperature={16} />
    );
  ...
  it('applique la couleur verte pour une température normale', () => {
    const { container } = render(
      <TemperatureCircle sensorName="Chambre" temperature={21} />
    );
  ...
  it('applique la couleur rouge pour une température chaude', () => {
    const { container } = render(
      <TemperatureCircle sensorName="Grenier" temperature={28} />
    );
  ...
  it('gère les températures négatives', () => {
    const { container } = render(
      <TemperatureCircle sensorName="Congélateur" temperature={-5} />
    );
  ...
  it('gère les températures très élevées', () => {
    const { container } = render(
      <TemperatureCircle sensorName="Four" temperature={45} />
    );
  ...
  it('arrondit la température à 1 décimale', () => {
    const { container } = render(
      <TemperatureCircle sensorName="Capteur" temperature={22.567} />
    );
  ...
  it('rend le cercle SVG', () => {
    const { container } = render(
      <TemperatureCircle sensorName="Test" temperature={20} />
    );
